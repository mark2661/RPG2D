...
OBJECT_ENTITY_SCALE_SIZE = ORIGINAL_TILE_SIZE * 3
OBJECT_ENTITY_FADE_COOLDOWN_TIME = 50  # milliseconds
OBJECT_ENTITY_ALPHA_VALUE_FADE_RATE = 50
...
HEALTH_POTION_IMAGES_FILE_PATH = os.path.join(ROOT_DIR, "graphics", "objects", "health")
